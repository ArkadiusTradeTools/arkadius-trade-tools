...
local function WriteLine(args)
    OUT_FILE:write(args.guildName .. "," .. args.startTimeStamp .. "," .. args.endTimeStamp .. "," .. escapeQuotes(args.displayName) .. "," .. tostring(args.member) .. "," .. args.salesVolume .. "," .. args.purchaseVolume .. "," .. (args.rankIndex or "") .. "," .. (args.rankName or "") .. "," .. args.taxes .. "," .. args.purchaseTaxes .. "," .. args.salesCount .. "," .. args.purchaseCount .. "," .. args.internalSalesVolume .. "," .. args.itemCount .. "\n")
end
...
table.sort(sortedExportsData.data, function(a, b)
